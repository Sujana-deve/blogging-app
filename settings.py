...
SECRET_KEY = 'django-insecure-_!251_!ab@p9n9)(+t(_133^66oh5t0&wsi8h0@2cpwg=cjlrr'
...
# Register external or custom apps
EXTERNAL_APPS = [
    'gallery',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Templates directory for custom templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Directory for user-uploaded media
